...
main(int argc, char *argv[]) {
    ...
    //Fat tree parameters
    DataRate networkBandwidth("1000Gbps");
    ...
    cmd.AddValue("Duration", "Number of hosts in each side", duration);
...
//		LogComponentEnable("Ipv4GlobalRouting", LOG_DEBUG);
    ...
    system(("cp " + inputDir + "rtt_cdf.txt " + outputNameRoot + "rtt_cdf.txt").c_str());
